...
public class Log4jMBean {
	 ...
	 * Log4jMbean注册的名称.
	 */
	public static final String LOG4J_MBEAN_NAME = "Solex:type=Log4jManagement,name=log4jManagement";

	private static org.slf4j.Logger mbeanLogger = LoggerFactory
			.getLogger(Log4jMBean.class);
