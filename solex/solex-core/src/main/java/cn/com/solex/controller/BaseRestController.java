 ...
 *            实体主键
 */
public class BaseRestController<T, PK> extends BaseController {
	...
	public ModelAndView _new(HttpServletRequest request,
			HttpServletResponse response, T model) throws Exception {
		throw new UnsupportedOperationException("not yet implement");
	}

	/** 显示 */
	@RequestMapping(value = "/{id}")
	public ModelAndView show(@PathVariable PK id, HttpServletRequest request,
	...
	public ModelAndView edit(@PathVariable PK id, HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		throw new UnsupportedOperationException("not yet implement");
	}
	...
	public ModelAndView delete(@PathVariable PK id, HttpServletRequest request,
